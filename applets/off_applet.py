...
def applet_shutdown(globals_list: list) -> None:
    ...
    LineRenderer.TerminalRenderAgent.add("Shutdown in 4")
    time.sleep(1)
    LineRenderer.TerminalRenderAgent.remove(len(list(LineRenderer.TerminalRenderAgent)))
    LineRenderer.TerminalRenderAgent.add("Shutdown in 3")
    time.sleep(1)
    LineRenderer.TerminalRenderAgent.remove(len(list(LineRenderer.TerminalRenderAgent)))
    LineRenderer.TerminalRenderAgent.add("Shutdown in 2")
    time.sleep(1)
    LineRenderer.TerminalRenderAgent.remove(len(list(LineRenderer.TerminalRenderAgent)))
    LineRenderer.TerminalRenderAgent.add("Shutdown in 1")
    time.sleep(1)
    LineRenderer.TerminalRenderAgent.remove(len(list(LineRenderer.TerminalRenderAgent)))
    LineRenderer.TerminalRenderAgent.add("Shutting down...")
    time.sleep(1)
